...
public class Help implements Commande {
	...
	public Help() {
		...
		help.put("MOVE", "<p><b><u><font color=#FF0000>MOVE :</font></u></b><br> " +
				...
				"Vous pouvez choisir de dessiner aléatoirement, pour cela il faudra saisir : MOVE RANDOM RANDOM</p>");
		
		help.put("NEW", "<p><b><u><font color=#FF0000>NEW :</font></u></b><br> " +
				"Commande qui crée un nouvel éditeur. A la saisie de la commande une boite de dialogue est ouverte et vous propose, de sauvegarder ou non votre dessin ou d'annuler la commande. <br>" +
				"Si vous souhaitez sauvegarder, une autre fenetre vous proposera l'endroit où vous voudrez l'enregistrer. Sinon, l'historique de votre dessin et le dessin sera supprimé et vous reviendrez sur un éditeur de fond blanc.<br>" +
				"Dans le cas où vous annulez la commande rien ne se passe.<br>" +
		...
		help.put("OPEN", "<p><b><u><font color=#FF0000>OPEN :</font></u></b><br> " +
				...
				"Mais si vous voulez faire un nouveau dessin à partir du fichier ouvert vous pouvez indiquer l'option NEW, ex: OPEN NEW ou bien OPEN NEW C:\\chemin_du_fichier.txt</p>");
		...
		help.put("PENCOLOR", "<p><b><u><font color=#FF0000>PENCOLOR :</font></u></b><br> " +
				...
				"Cette commande peut aussi prendre une chaine de caractere correspondant à une couleur, ainsi, vous pouvez taper directement en argument red, rouge, white, blanc, black, noir,yellow, jaune,blue, bleu, cyan, rose, pink, orange, magenta, green, vert, gray ou gris. <br>" +
				"ATTENTION gris fonce (dark gray) et gris clair (light gray) doivent être écrit en attaché, exemple : PENCOLOR grisfonce (PENCOLOR 	darkgray) </p>");
		...
		help.put("PENSIZE", "<p><b><u><font color=#FF0000>PENSIZE :</font></u></b><br> " +
				"On peut changer la taille du pinceau grace à  cette commande, elle prend comme argument un entier compris entre 1 et 99.</p>");
		...
		help.put("REMEMBER", "<p><b><u><font color=#FF0000>REMEMBER :</font></u></b><br> " +
				"Enregistre les coordonnées (abscisse, ordonnee et direction) du curseur actuel. Cette commande ne prend aucun argument.</p>");
		...
		help.put("UNDO", "<p><b><u><font color=#FF0000>UNDO :</font></u></b><br> " +
				"Elle annule la commande qui lui est precedente. Mais uniquement les commandes qui permettent de dessiner, donc uniquement MOVE et REPEAT. Et garde l'angle que vous avez donné. Cette commande ne prend aucun argument</p>");
		...
		help.put("VAR", "<p><b><u><font color=#FF0000>VAR :</font></u></b><br> " +
				"Cette commande vous permet de declarer des variables et/ou de modifier leurs valeurs. Une déclaration de variable commence toujours par VAR_*, mais pour l'utilisation elle comme toujours par un underscore \"_\" suivi du nom de la variable donnée. Voici les 3 cas possibles<br>" +
				...
				"</ul>" +
				"Les operations permises sont \"+, -, *, et /\". <br> Pour avoir la liste des variables que vous avez declare VAR info <b>Attention</b> il n'est possible de faire des opÃ©ration que sur deux variables a la fois</p>");
