...
public class PenColor implements Commande {

	/**
	 * convertiCouleur converti le parametre entr� en la couleur demand�e et
	 * mettra la couleur de fond en la couleur voulu
	 * 
	 * converti les 13 couleurs de JAVA pr�d�fini, et les valeurs hexad�cimales
	 * 
	 * @param s
	 * 
	...
	public void execute(String[] parametres, boolean addToHistory) {
		...
		Fenetre.jPanelDessin.curseur.setCouleur(convertiCouleur(parametres[1]));
		Fenetre.jButtonCouleur.setBackground(convertiCouleur(parametres[1]));
		if (addToHistory)
	...
	/**
	 * Verifie que le parametre entre est correct
	 * 
	 * @param s recupere le parametre de couleur
	 * 
	 * @return true
	 * 
